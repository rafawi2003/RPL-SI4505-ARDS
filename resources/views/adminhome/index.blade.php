...
<body>
    ...
    <section class="hero-section">
        ...
        @auth
                <a href="{{ url('/admin') }}" class="btn btn-lg btn-login me-md-2">Dashboard</a>
            @else
...
<section class="about-section">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="{{ asset('images/image 3.png') }}" class="img-fluid rounded mb-3" alt="About Asrama" style="max-width: 100%; height: auto;">
            </div>
            <div class="col-md-6">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- images denah -->
                <img src="{{ asset('images/Denah.png') }}" class="img-fluid rounded mb-3" alt="Denah Asrama">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card mb-4 h-100">
                <img src="{{ asset('images/gedung 1.png') }}" alt="asrama putri" class="card-img-top">
        ...
        <div class="col-md-6">
            <div class="card mb-4 h-100">
                <img src="{{ asset('images/gedung2.png') }}" alt="asrama putra" class="card-img-top">
                <div class="card-header" style="background-color: #D92E2D; color: white; text-align: center;">
        ...
        <div class="carousel-item">
            <div class="row">
                <div class="col-md-6">
                    <div class="card mb-4 h-100">
                        <img src="{{ asset('images/lobby.png') }}" alt="Lobby Asrama" class="card-img-top">
                        <div class="card-header" style="background-color: #D92E2D; color: white; text-align: center;">
                ...
                <div class="col-md-6">
                    <div class="card mb-4 h-100">
                        <img src="{{ asset('images/fasilitas-kamar.jpg') }}" alt="Kamar Asrama" class="card-img-top">
                        <div class="card-header" style="background-color: #D92E2D; color: white; text-align: center;">
...
<div id="facility-olahraga" class="facility-content">
    <div id="carouselOlahraga" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                <div class="facility">
                    <img src="{{ asset('images/fasilitas_olahraga_kesehatan/joggingtrack.png') }}" class="d-block w-100 facility-img" alt="Jogging Track">
            ...
            <div class="carousel-item">
                <div class="facility">
                    <img src="images/fasilitas/lapanganbasket.jpg" class="d-block w-100 facility-img" alt="Lapangan Basket">
                    <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <div class="facility">
                    <img src="images/fasilitas/lapanganvolly.jpg" class="d-block w-100 facility-img" alt="Lapangan Volly">
                    <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <div class="facility">
                    <img src="images/fasilitas/lapanganfutsal.jpg" class="d-block w-100 facility-img" alt="Lapangan Futsal">
                    <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <div class="facility">
                    <img src="images/fasilitas/lapanganbulutangkis.jpg" class="d-block w-100 facility-img" alt="Lapangan Bulutangkis">
                    <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <div class="facility">
                    <img src="images/fasilitas/lapangantennis.jpg" class="d-block w-100 facility-img" alt="Lapangan Tennis">
                    <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <div class="facility">
                    <img src="images/fasilitas/kolamrenang.jpg" class="d-block w-100 facility-img" alt="Kolam Renang">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Kolam Renang</h5>
            ...
            <div class="carousel-item">
                <div class="facility">
                    <img src="images/fasilitas/gym.jpg" class="d-block w-100 facility-img" alt="Ruang Gym">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Ruang Gym</h5>
            ...
            <div class="carousel-item">
                <div class="facility">
                    <img src="images/fasilitas/klinik.jpg" class="d-block w-100 facility-img" alt="Klinik Pratama THC">
                    <div class="carousel-caption d-none d-md-block">
...
<div id="facility-makanan" class="facility-content active">
    <div class="row">
        ...
        <div class="col-md-3 mb-4">
            <div class="card">
                <img src="{{ asset('images/fasilitas_makanan_rekreasi/kantin.png') }}" class="card-img-top img-fluid" alt="Kantin">
                <div class="card-body">
...
<div id="facility-area" class="facility-content">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    <img src="{{ asset('images/fasilitas_area_siswa/pendopo.png') }}" class="card-img-top img-fluid" alt="Pendopo Tel-U">
                    <div class="card-body">
