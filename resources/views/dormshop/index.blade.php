            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-gray-100 border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <!-- Token Listrik -->
                        <a href="{{ route('dormshop.token_listrik.index') }}" class="bg-white rounded-lg shadow-md p-4 block hover:bg-gray-50 transition duration-200">
                        ...
                        -->
                        <!-- Pembayaran Wifi -->
                        <a href="{{ route('pembayaran_wifi.index') }}" class="bg-white rounded-lg shadow-md p-4 block hover:bg-gray-50 transition duration-200">
