        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('upload_bukti_pembayaran_listrik.store', $transaction->id) }}" enctype="multipart/form-data">
                        @csrf
                        <!-- Input untuk mengunggah file bukti pembayaran -->
                        <div class="mb-4">
                            <label for="bukti_pembayaran_listrik" class="block text-gray-700 text-sm font-bold mb-2">Unggah Bukti Pembayaran Listrik</label>
                            <input id="bukti_pembayaran_listrik" type="file" class="form-control rounded-md shadow-sm mt-1 block w-full" name="bukti_pembayaran_listrik" required>
                        </div>
                        <!-- Tombol Unggah -->
